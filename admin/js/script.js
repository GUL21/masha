$(document).ready(function() {
 ...
 $(this).next().slideToggle(400); 
  ...
  $('<div id="addimage'+count_input+'" class="addimage"><input type="hidden" name="MAX_FILE_SIZE" value="2000000"/><input type="file" name="galleryimg[]" /><a class="delete-input" rel="'+count_input+'" >Óäàëèòü</a></div>').fadeIn(300).appendTo('#objects'); 
